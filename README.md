...
The notebook `Navigation.ipynb` contains the code to set up the environment and the outer episode iteration to solve the reinforcement problem. 
My solution uses a <b>double deep Q-learning network and experience replay</b>.

Here are the steps taken in building an agent that solves this environment.
...
- Reference : Double-Q-Network (see also [this paper](https://arxiv.org/abs/1509.06461)). 
